...
export const classicThemes: Theme[] = [
  ...
  },
  {
    id: 'modern-pro',
    name: '现代专业',
    description: '基于微信公众号优化的现代专业风格，章节编号突出，视觉层次丰富',
    styles: {
      ...
      p: 'text-align: justify;font-size: 17px;color: rgba(0, 0, 0, 0.9);line-height: 1.8;margin-bottom: 24px;margin-left: 10px; margin-right: 10px;',
      span: 'font-size: 18px;',
      ...
      blockquote: 'margin: 24px 0; padding: 18px 20px 18px 24px; background-color: #f8f9fc !important; border-left: 4px solid #4A90D9; color: #444444 !important; border-radius: 0 8px 8px 0; font-style: italic;',
      ...
      pre: 'margin: 24px 0; padding: 20px; background-color: #f8f9fc !important; border-radius: 12px; overflow-x: auto; font-size: 14px !important; line-height: 1.6 !important; border: 1px solid #e8eef8;',
